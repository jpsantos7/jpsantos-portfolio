...
import { isDarkModeActivated, isReducedMotionActivated } from './helpers';
...
export default class SiteState {
  ...
  setA11yPreferencesBasedOnStorage() {
    const a11yPreferencesObj =
      this.getLocalStoragedA11yPreferencesObj() || this.setAndGetFirstLocalStoragedA11yPreferences();
