...
import { KEYCODES, PORTFOLIO_MODAL_ACTIVE_CLASSNAME, SITE_DIRECTIONS } from '../constants';
...
export default class Portfolio {
  ...
  portfolioCarouselNavHandlers(action) {
    ...
    queryAll('.portfolio-nav__button--close').forEach(button =>
      button[action + 'EventListener']('click', this.triggerClosePortfolioModal.bind(this))
    );
  }
